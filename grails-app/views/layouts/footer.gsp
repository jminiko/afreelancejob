...
<div class="footer-top-area">
    <div class="container">
        <div class="row row-wrap">
            ...
            <div class="col-md-3">
                <h4>S'abonner &agrave; la Newsletter</h4>
                <div class="box">
                    <form>
                        ...
                        <p class="mb10">envoi d'une newsletter</p>
                        <input type="submit" class="btn btn-primary" value="S'enregistrer" />
                    </form>
                </div>
            </div>
            <div class="col-md-3">
                <h4>A freelance job sur Twitter</h4>
                <!-- START TWITTER -->
                ...
                <div class="col-md-3">
                    ...
                    <ul class="thumb-list">
                        <li>
                            <a href="#">
                                <img src="${resource(dir: 'img',file:'70x70.png')}" alt="Image Alternative text" title="Urbex Esch/Lux with Laney and Laaaaag" />
                            </a>
                            <div class="thumb-list-item-caption">
                                <p class="thumb-list-item-meta">20 Juin, 2015</p>
                                <h5 class="thumb-list-item-title"><a href="#">lancement du site</a></h5>
                                <p class="thumb-list-item-desciption">Version beta (0.1)</p>
                            </div>
                        </li>
                    </ul>
                </div>
